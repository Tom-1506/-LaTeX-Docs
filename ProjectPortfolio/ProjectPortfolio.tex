...
chosen point. The leaf would then need to be rotated to face upwards and make sure that the leaf 
is rotated so it does not clip with the branch it is on.
